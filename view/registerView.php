...
<?php ob_start(); ?>
    ...
    <div id="registration_container"> <!-- Cadre contenant le formulaire -->
        ...
        <form action="index.php?action=register" method="POST" name="register" onsubmit="return validateForm()"> <!--  formulaire d'inscription  -->
            ...
            <input type="number" placeholder="taille en cm" name="height" required>

            <label><b>Poids</b></label>
            <input type="number" placeholder="poids en kg" name="weight" required>

            <label><b>Sexe</b></label>
            <select name="sex">
                <option value="Femme" autofocus>Femme</option>
