...
<?php ob_start(); ?>
    ...
    <div id="registration_container"> <!-- Cadre contenant le formulaire -->
        ...
        <form action="index.php?action=register" method="POST" name="register" onsubmit="return validateForm()"> <!--  formulaire d'inscription  -->
            ...
            <input type="text" placeholder="Entrer your name" name="lastName" required>

            <label><b>Last name</b></label>
            <input type="text" placeholder="Enter your last name" name="firstName" required>
            ...
            <input type="number" placeholder="height in cm" name="height" required>

            <label><b>weight</b></label>
            <input type="number" placeholder="weight in kg" name="weight" required>

            <label><b>Sex</b></label>
            <select name="sex">
                <option value="Femme" autofocus>Women</option>
            ...
            <br>
            <br>
            <a href="index.php?action=connect">I already have an account</a>
